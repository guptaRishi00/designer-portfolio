...
const BlogPost = ({ image, date, title, excerpt }) => (
  <div className="col-lg-6">
    <div className="rounded-1 bg-dark-2 overflow-hidden">
      <div className="row g-0">
        <div className="col-sm-6">
          ...
          >
            <div className="abs start-0 top-0 bg-color text-white p-3 pb-2 m-3 text-center fw-600 rounded-1">
        ...
        <div className="col-sm-6 relative">
          <div className="p-30 pb-60">
            <h4 className="fs-28 lh-1-2">
              <Link className="text-light" href="/06_blog-single">
                {title}
              </Link>
            </h4>
            ...
            <div className="abs bottom-0 pb-20">
              <div className="d-inline fs-14 fw-600 me-3">
                <i className="icofont-chat id-color me-2" />
                10 Comments
              </div>
            </div>
          </div>
